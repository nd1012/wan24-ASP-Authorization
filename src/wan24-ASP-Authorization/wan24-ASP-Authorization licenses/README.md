...
published in the 
[GitHub repository](https://github.com/nd1012/wan24-ASP-Authorization).
...
## wan24-ASP-Authorization referenced libraries

The published `wan24-ASP-Authorization` library uses the following referenced 
